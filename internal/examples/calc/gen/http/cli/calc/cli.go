...
import (
	...
	calcc "github.com/eric-isakson/goaeric/internal/examples/calc/gen/http/calc/client"
...
func calcUsage() {
	fmt.Fprintf(os.Stderr, `The calc service exposes public endpoints that perform numeric calculations.
Usage:
